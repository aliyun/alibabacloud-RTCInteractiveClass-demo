    ...
    methods: {
      ...
      getDevices() {
        RTCClient.instance.getDevices().then(re => {
          ...
          RTCClient.instance.currentAudioCapture(this.audioDevices[0].deviceId);
          this.startPreview();
        })
      },
      /**
      ...
      switchCamera(deviceId) {
        RTCClient.instance.stopPreview().then(() => {
          RTCClient.instance.currentCamera(deviceId);
          this.startPreview();
        })
      },
      /**
      ...
      switchtAudioCapture(deviceId) {
        RTCClient.instance.stopPreview().then(() => {
          RTCClient.instance.currentAudioCapture(deviceId);
          this.startPreview();
        })
      },
      /**
