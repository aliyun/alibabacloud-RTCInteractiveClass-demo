...
struct Bool {
  ...
  struct Boxed {
    ...
    static CppType toCpp(ObjcType x) noexcept {
      return x ? Bool::toCpp([x boolValue]) : false;
    }
    static ObjcType fromCpp(CppType x) noexcept {
      return [NSNumber numberWithBool:Bool::fromCpp(x)];
    }
  };
};
...
struct Primitive {
  ...
  struct Boxed {
    using ObjcType = NSNumber*;
    static CppType toCpp(ObjcType x) noexcept {
      return x ? static_cast<CppType>(Self::unbox(x)) : CppType(0);
    }
...
class I8 : public Primitive<I8, int8_t> {
  ...
  static Boxed::ObjcType box(CppType x) noexcept {
    return [NSNumber numberWithChar:static_cast<char>(x)];
  }
};
...
class I16 : public Primitive<I16, int16_t> {
  ...
  static Boxed::ObjcType box(CppType x) noexcept {
    return [NSNumber numberWithShort:static_cast<short>(x)];
  }
};
...
class I32 : public Primitive<I32, int32_t> {
  ...
  static Boxed::ObjcType box(CppType x) noexcept {
    return [NSNumber numberWithInt:static_cast<int>(x)];
  }
};
...
class I64 : public Primitive<I64, int64_t> {
  ...
  static Boxed::ObjcType box(CppType x) noexcept {
    return [NSNumber numberWithLongLong:static_cast<long long>(x)];
  }
};
...
struct Enum {
  ...
  static ObjcType fromCpp(CppType e) noexcept {
    return static_cast<ObjcType>(e);
  }

  struct Boxed {
    using ObjcType = NSNumber*;
    static CppType toCpp(ObjcType x) noexcept {
      return toCpp(x, Tag<typename std::underlying_type<CppType>::type>());
    }
    static ObjcType fromCpp(CppType x) noexcept {
      return fromCpp(x, Tag<typename std::underlying_type<CppType>::type>());
    }
   ...
   private:
    ...
    static CppType toCpp(ObjcType x, Tag<int>) noexcept {
      return Enum::toCpp(static_cast<Enum::ObjcType>([x integerValue]));
    }
    static ObjcType fromCpp(CppType x, Tag<int>) noexcept {
      return
          [NSNumber numberWithInteger:static_cast<NSInteger>(Enum::fromCpp(x))];
    }

    static CppType toCpp(ObjcType x, Tag<unsigned>) noexcept {
      return Enum::toCpp(static_cast<Enum::ObjcType>([x unsignedIntegerValue]));
    }
    static ObjcType fromCpp(CppType x, Tag<unsigned>) noexcept {
      return [NSNumber
          numberWithUnsignedInteger:static_cast<NSUInteger>(Enum::fromCpp(x))];
    }
  };
};
...
static NSStringEncoding getWCharEncoding() {
  static_assert(wcharTypeSize == 2 || wcharTypeSize == 4,
...
struct Date {
  ...
  static CppType toCpp(ObjcType date) {
    ...
    return POSIX_EPOCH +
           duration_cast<system_clock::duration>(timeIntervalSince1970);
  }
  ...
  static ObjcType fromCpp(const CppType& date) {
    ...
    static const auto POSIX_EPOCH = system_clock::from_time_t(0);
    return
        [NSDate dateWithTimeIntervalSince1970:duration_cast<duration<double>>(
                                                  date - POSIX_EPOCH)
                                                  .count()];
  }
};
...
struct Binary {
  ...
  static ObjcType fromCpp(const CppType& bytes) {
    ...
    return bytes.empty()
               ? [NSData data]
               : [NSData dataWithBytes:bytes.data()
...
class Optional {
  ...
  // std::shared_ptr<T>, not optional<shared_ptr<T>> or
  // optional<nn<shared_ptr<T>>>.
  template <typename C>
...
class List {
 ...
 public:
  ...
  static ObjcType fromCpp(const CppType& v) {
    ...
    auto array =
        [NSMutableArray arrayWithCapacity:static_cast<NSUInteger>(v.size())];
...
class Set {
 ...
 public:
  using CppType = std::set<ECppType>;
...
class Map {
 ...
 public:
  using CppType = std::map<CppKeyType, CppValueType>;
  ...
  static CppType toCpp(ObjcType map) {
    ...
    if (map) {
      ...
      // m.reserve(map.count);
      [map enumerateKeysAndObjectsUsingBlock:^(ObjcKeyType key,
                                               ObjcValueType obj, BOOL*) {
  ...
  static ObjcType fromCpp(const CppType& m) {
    ...
    auto map = [NSMutableDictionary
        dictionaryWithCapacity:static_cast<NSUInteger>(m.size())];
    for (const auto& kvp : m) {
      [map setObject:Value::Boxed::fromCpp(kvp.second)
              forKey:Key::Boxed::fromCpp(kvp.first)];
    }
    return [map copy];
  }
};
