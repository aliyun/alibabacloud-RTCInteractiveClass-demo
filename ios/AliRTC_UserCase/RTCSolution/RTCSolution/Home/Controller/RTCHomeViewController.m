...
//    //功能配置
//
//    NSInteger shouldAddValue = 0b11111111;
//
//
//    for (int i = 0; i < 16; i ++) {
...
//    }
    ...
    RTCModuleDefine *module = [[RTCModuleDefine alloc]initWithModuleType:RTC_ModuleType_InteractiveClass];
    [mArray addObject:module];
...
//            [self configImageBundleWithType:module.type];
            switch (module.type) {
                ...
                //一起看
                case RTC_ModuleType_WatchTogether:[self pushTargetVCWithClassString:@"WTLoginController"];break;
