...
public class AlivcTipDialog extends Dialog implements View.OnClickListener {
    ...
    private void setData() {
        ...
        if (mBuilder.mDrawable > 0) {
            mIvTip.setVisibility(View.VISIBLE);
            mIvTip.setBackground(ContextCompat.getDrawable(getContext(), mBuilder.mDrawable));
        }
    ...
    private void initView() {
        ...
        mIvTip = findViewById(R.id.alivc_voicecall_iv_tip_dialog_tip);
    ...
    public static class Builder {
        ...
        public Builder setDrawableTip(int drawable) {
            mDrawable = drawable;
            return this;
        }
